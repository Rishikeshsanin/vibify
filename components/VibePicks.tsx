              ...
              return (
                <article className={`vibe-pick-card ${roomWantsIt ? 'room-wants-it' : ''}`} key={pick.id}>
                  ...
                  <div className="vibe-pick-body">
                    ...
                    {pick.voterNames.length > 0 && <p className="vibe-voters">{formatVoters(pick.voterNames)}</p>}
                    ...
                    {isHost ? (
                      ...
                      <button className={`vibe-vote-button ${pick.votedByMe ? 'is-voted' : ''}`} onClick={() => onVote(pick)}>
